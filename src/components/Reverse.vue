    ...
    <div id="reverse">
        ...
        <section class="w-80-ns w-100 ph-2">
            ...
            <form id="form-reverse" class="center ph3-ns">
                ...
                <input type="text" name="lat" id="lat" placeholder="37.4224764" class="input-reset mv2" />

                <label for="long" class="label">Longitude</label>
                <input type="text" name="long" id="long" placeholder="-122.0842499" class="input-reset mv2" />
